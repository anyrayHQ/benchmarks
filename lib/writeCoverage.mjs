...
// survival). The registry column — the 25 kinds, their cache flags, and their
...
/**
 * The 25 registered kinds, mirrored from the monorepo. Provenance:
 ...
 *                         from DEFAULT_CONFIG entirely. Verified against
 *                         optimizer 0.3.201 (monorepo main, 2026-09-23).
...
export const REGISTRY_MIRROR = [
  ...
  { kind: 'client_prefix_compression', flags: [], enabled: false, docsRef: 'strategy page' },
  { kind: 'prompt_compression', flags: [], enabled: true, docsRef: 'strategy page' },
  { kind: 'context_dedupe', flags: ['cacheBusting'], enabled: true, docsRef: 'strategy page' },
  ...
  { kind: 'semantic_cache', flags: [], enabled: false, docsRef: 'strategy page' },
  ...
  { kind: 'columnar_fold', flags: [], enabled: false, docsRef: 'strategy page' },
  { kind: 'repeat_factor', flags: ['cacheBusting'], enabled: true, docsRef: 'strategy page' },
];
