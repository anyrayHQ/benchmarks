...
export function resolveLiveConfig(cfg, env = process.env) {
  ...
  return {
    ...
    // Live model calls (esp. extended-thinking baselines) run far longer than the
    // optimizer hook; config live.timeout_ms owns this ceiling, not request_timeout_ms.
    timeoutMs: live.timeout_ms ?? 300000,
    judge: {
