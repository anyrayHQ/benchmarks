...
| Vocab-mismatch RAG (20 chunks) — "what revokes their credential?" | `relevance_filter` | `keepChars=1500, roles=tool\|function\|user, semanticRerank=true, semanticWeight=0.7` | 2,266 | 566 | **75%** |
