...
|---|---|---|--:|--:|--:|
| GitHub triage — "which open issues are P0 auth bugs?" | `relevance_filter` | `keepChars=2000, roles=user` | 5,583 | 897 | **84%** |
| Long agent session — keep a 60-message session inside the window | `window_budget` | `maxTokens=24000` | 82,110 | 22,905 | **72%** |
...
| Long tool-call session — fit a 10-file investigation in budget | `window_budget` | `maxTokens=2500` | 3,509 | 2,205 | **37%** |
