...
Across 22 synthetic agent/coding workloads, the Anyray optimizer cut input tokens by **72% overall** (median 72% per workload) while preserving the answer-bearing key facts in **91%** of cases (91% confirmed by an LLM judge).
...
- **20/22** confirmed by the LLM judge.
